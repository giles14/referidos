                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-5 offset-1">
                            <input type="text" id="correo" name="correo" class="form-control" placeholder="Correo electrónico" minlength="3" required>
                            <div class="valid-feedback feedback-icon">
                                <i class="fa fa-check"></i>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-5 offset-1">
                            <input type="text" name="codigo" class="form-control is-valid" value="LSP0721" placeholder="Código de la promoción" readonly="readonly">
                            <div class="valid-feedback feedback-icon">
                                <i class="fa fa-check"></i>
                            </div>
